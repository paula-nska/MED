...
project_root = os.path.join(os.getcwd(), 'C:\\Users\\Paula\\Desktop\\MED\\owoce\\root_directory')
parent_dir = os.path.join(os.getcwd(), '../')
data_dir = os.path.join(parent_dir, 'data/')
fruit_models_dir = os.path.join(parent_dir, 'fruit_models/')
labels_file = os.path.join(parent_dir, 'C:\\Users\\Paula\\Desktop\\MED\\owoce\\root_directory\\utlis')
